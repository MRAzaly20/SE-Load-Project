...
const getRoleNavItems = (role: string): NavItem[] => {
  ...
  if (role === "admin") {
    return [
      ...
      {
        icon: <PageIcon />,
        name: "Project Master CRUD",
        path: "/admin#projects",
      },
      {
        icon: <TableIcon />,
        name: "Allowance Policies",
        path: "/admin#policies",
      },
      {
        icon: <PlugInIcon />,
        name: "Ingestion Bridge Test",
...
const AppSidebar: React.FC = () => {
  ...
  // Strict Access Level Navigation (User role assigned by Admin overrides fallback)
